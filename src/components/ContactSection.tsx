    ...
    <section id="contact" className="py-24 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <span className="text-primary font-mono text-sm mb-2 block">{t.contact.sectionTitle}</span>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="glass-card rounded-xl p-6 glow-primary">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="font-mono font-medium">{t.hero.available}</span>
              </div>
            ...
            <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-6 md:p-8 space-y-6">
              {isSubmitted ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <h3 className="font-mono font-semibold text-xl mb-2">{t.contact.form.success.split('!')[0]}!</h3>
                  <p className="text-muted-foreground">{t.contact.form.success.split('!')[1]?.trim()}</p>
                </div>
              ) : (
                <>
